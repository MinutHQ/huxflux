...
export function ModelSelectTrigger({ provider, providerName, label, open, onClick }: {
  ...
  const color = provider === "claude"
    ...
    : provider === "codex"
      ? "border-blue-500/60 bg-blue-500/20 text-blue-950 hover:bg-blue-500/30 hover:text-blue-950 aria-expanded:bg-blue-500/30 aria-expanded:text-blue-950 dark:border-blue-400/70 dark:bg-blue-500/30 dark:text-blue-50 dark:hover:bg-blue-500/40 dark:hover:text-blue-50 dark:aria-expanded:bg-blue-500/40 dark:aria-expanded:text-blue-50"
  ...
  return (
    ...
    >
      {provider === "claude" ? <IconAsterisk size={19} className="shrink-0 text-orange-500" />
        : provider === "codex" ? <IconBrandOpenai size={19} className="shrink-0 text-blue-500" />
