import { api, useServerConfig, type PullRequest, queryKeys, useHuxfluxQuery } from "@huxflux/shared"
...
export function usePRs() {
  ...
  const { data, isLoading, refetch } = useHuxfluxQuery({
    queryKey: queryKeys.prs.list(),
    queryFn: () => api.prs.list(),
