...
import type { OpenFile, FileTab } from "@/app-shell/workspace"
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 min-h-0 overflow-hidden">
        {openFile?.type === "diff" ? (
          ...
          <FileContentView agentId={agentId} filePath={openFile.path} />
          ...
          <AgentPRTab agentId={agentId} onAddComment={onAddComment} />
        ) : null}
      </div>
    </div>
  )
